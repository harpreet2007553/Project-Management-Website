...
export const getAllProjectTopics = asyncHandler(
    async (req , res) => {
        ...
        .status(201)
        .json(
            new ApiResponse(201, topics[0], "Topics fetched successfully")
        )
    }
)
...
export const deleteTopic = asyncHandler(
    async (req , res) => {
        ...
        .status(201)
        .json(
            new ApiResponse(201, deletedTopic, "Topic deleted successfully")
        )
    }
)